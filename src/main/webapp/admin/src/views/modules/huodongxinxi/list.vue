      ...
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column width="300" :align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('huodongxinxi','报名') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="huodongbaomingCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'报名':'' }}</el-button>
                <el-button v-if="isAuth('huodongxinxi','报名') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="huodongbaomingCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'报名':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('huodongxinxi','报名') && contents.tableBtnIcon == 0" type="success" size="mini" @click="huodongbaomingCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'报名':'' }}</el-button>
