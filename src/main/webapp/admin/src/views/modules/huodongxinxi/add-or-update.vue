    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="活动要求" prop="huodongyaoqiu">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.huodongyaoqiu" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.huodongyaoqiu" label="活动要求" prop="huodongyaoqiu">
                    <span v-html="ruleForm.huodongyaoqiu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zixundianhua = true;
          ...
          if(o=='huodongyaoqiu'){
            this.ruleForm.huodongyaoqiu = obj[o];
	    this.ro.huodongyaoqiu = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.huodongyaoqiu = this.ruleForm.huodongyaoqiu.replace(reg,'../../../ssmv0lc9/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
